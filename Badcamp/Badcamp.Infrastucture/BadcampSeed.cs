...
namespace Badcamp.Infrastucture
{
	internal class BadcampSeed
	{
        ...
        public void Seed()
        {
            ...
            if (!context.ArtistModels.Any())
            {
                context.ArtistModels.AddRange(
                    new ArtistModel
                    {
                        Name = "KA-ZZ",
            ...
            if (!context.Events.Any())
            {
                context.Events.AddRange(
                    new Event
                    {
                        Artist = context.ArtistModels.Where(x => x.Name == "Hubba").FirstOrDefault(),
                        Title = "Meet up",
                    ...
                    new Event
                    {
                        Artist = context.ArtistModels.Where(x => x.Name == "KA-ZZ").FirstOrDefault(),
                        Title = "Free Huggs",
